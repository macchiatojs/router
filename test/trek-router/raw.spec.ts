...
import type { Next } from '@macchiatojs/kernel';
...
describe('macchiatojs-router with express/connect style', () => {
  describe('self', () => {
    it('should return a object', () => {
      assert.strictEqual(typeof new Router({ trek: true, raw: true }), 'object')
    })
  ...
  describe('http verbs/methods', () => {
    it('get method', (done) => {
      const router = new Router({ trek: true, raw: true })
  ...
  describe('prefix as instance arg and method', () => {
    ...
    it('should prefix instance arg work', (done) => {
      const router = new Router({ trek: true, raw: true, prefix: '/preRoute' })
