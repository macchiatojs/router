...
describe('macchiatojs-router with koa.js', () => {
  ...
  describe('self', () => {
    it('should return a object', () => {
      assert.strictEqual(typeof new Router<Koa.Middleware>({ trek: true, expressify: false }), 'object')
    })
  ...
  describe('http verbs/methods', () => {
    it('get method', (done) => {
      const router = new Router<Koa.Middleware>({ trek: true, expressify: false })
